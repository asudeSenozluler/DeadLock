...
public class DeadlockOrnegi {
    ...
    public void LocklariKontrolEt(Lock a,Lock b) {
        ...
        while(true) {
            ...
            //eğer locku başka kimse almadıysa o locku alıp true değer döndürüyor
            ...
            if (aEldeEdildi == true) {
                ...
                a.unlock();
                //eğer locku alan başka bir thread varsa locku bıraktırmamız gerekiyor
            }
            if (bEldeEdildi == true) {
                b.unlock();
            }
    ...
    public void thread1Fonksiyonu(){
        ...
        //thread1 fonksiyonun 2 locka da sahip olması gerekiyor
    ...
    public void thread2Fonksiyonu(){
        ...
        //bu şekilde deadLocku önlemiş oluyoruz
